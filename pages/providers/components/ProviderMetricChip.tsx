...
const toneClass: Record<MetricTone, string> = {
  ...
  emerald: "bg-emerald-600/10 text-emerald-700 dark:bg-emerald-500/15 dark:text-emerald-200",
  rose: "bg-rose-600/10 text-rose-700 dark:bg-rose-500/15 dark:text-rose-200",
  amber: "bg-amber-500/15 text-amber-700 dark:bg-amber-500/15 dark:text-amber-200",
